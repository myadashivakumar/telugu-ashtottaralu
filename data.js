...
const DEITIES = {
  ...
  "durga": {
    ...
    "type": "verses",
    "verses": [
      { "label": "ధ్యాన శ్లోకం", "lines": ["ప్రథమం శైలపుత్రీ చ ద్వితీయం బ్రహ్మచారిణీ ।", "తృతీయం చంద్రఘంటేతి కూష్మాండేతి చతుర్థకమ్ ॥", "పంచమం స్కందమాతేతి షష్ఠం కాత్యాయనీతి చ ।", "సప్తమం కాలరాత్రీతి మహాగౌరీతి చాష్టమమ్ ॥", "నవమం సిద్ధిదాత్రీ చ నవదుర్గాః ప్రకీర్తితాః ।"] },
      { "label": "శైలపుత్రి", "lines": ["హిమవంతుని పుత్రిక; వృషభవాహన.", "కుడిచేత త్రిశూలం, ఎడమచేత కమలం ధరించి శిరమున చంద్రవంకను కలిగియుండును."] },
      { "label": "బ్రహ్మచారిణి", "lines": ["తపమాచరించు తల్లి; జ్యోతిర్మయ స్వరూపిణి.", "కుడిచేత జపమాల, ఎడమచేత కమండలువు ధరించును."] },
      { "label": "చంద్రఘంట", "lines": ["శిరమున అర్ధచంద్రుని ఘంటాకృతిలో ధరించి యుండును.", "సింహవాహన; సర్వదా యుద్ధముద్రలో నుండి భక్తులకు సౌమ్యముగా కానవచ్చును."] },
      { "label": "కూష్మాండ", "lines": ["దరహాసముతో బ్రహ్మాండమును సృజించు తల్లి గావున ఈ పేరు వచ్చెను.", "అష్టభుజాదేవి; సూర్యమండలాంతర్వర్తిని, సింహవాహన."] },
      { "label": "స్కందమాత", "lines": ["కుమారస్వామి (స్కందుని) తల్లి గావున 'స్కందమాత' అని పేరు.", "చతుర్భుజ, పద్మాసన, సింహవాహన."] },
      { "label": "కాత్యాయని", "lines": ["కాత్యాయన మహర్షి గృహమున పుత్రికగా అవతరించినది.", "సింహవాహన; విజయదశమి నాడు మహిషాసురుని వధించినది."] },
      { "label": "కాళరాత్రి", "lines": ["గాఢాంధకారము వంటి శరీరవర్ణము గలది; గార్దభవాహన.", "రూపము భయానకమైనను ఎల్లప్పుడూ శుభములనే ప్రసాదించుటచే 'శుభంకరి' యనియు అంటారు."] },
      { "label": "మహాగౌరి", "lines": ["శ్వేతవర్ణ శోభితురాలు; చతుర్భుజ, వృషభవాహన.", "కుడిచేతులలో అభయముద్ర, త్రిశూలము; ఎడమచేతులలో డమరుకము, వరముద్ర ధరించును."] },
      { "label": "సిద్ధిదాత్రి", "lines": ["సర్వవిధ సిద్ధులను ప్రసాదించు తల్లి గావున 'సిద్ధిదాత్రి'.", "చతుర్భుజ, కమలాసీన, సింహవాహన."] }
    ]
    }
    ],
    "color": "#A11D2E",
  ...
  "navagraha": {
    ...
    "type": "verses",
    "verses": [
      { "label": "ధ్యాన శ్లోకం", "lines": ["ఆదిత్యాయ చ సోమాయ మంగళాయ బుధాయ చ ।", "గురు శుక్ర శనిభ్యశ్చ రాహవే కేతవే నమః ॥"] },
      { "label": "రవి (సూర్యుడు)", "lines": ["జపాకుసుమ సంకాశం కాశ్యపేయం మహాద్యుతిమ్ ।", "తమోఽరిం సర్వ పాపఘ్నం ప్రణతోస్మి దివాకరమ్ ॥"] },
      { "label": "చంద్రుడు", "lines": ["దధిశంఖ తుషారాభం క్షీరార్ణవ సముద్భవం ।", "నమామి శశినం సోమం శంభోర్మకుట భూషణమ్ ॥"] },
      { "label": "కుజుడు (అంగారకుడు)", "lines": ["ధరణీ గర్భ సంభూతం విద్యుత్కాంతి సమప్రభమ్ ।", "కుమారం శక్తిహస్తం తం కుజం ప్రణమామ్యహమ్ ॥"] },
      { "label": "బుధుడు", "lines": ["ప్రియంగు కలికాశ్యామం రూపేణా ప్రతిమం బుధమ్ ।", "సౌమ్యం సౌమ్యగుణోపేతం తం బుధం ప్రణమామ్యహమ్ ॥"] },
      { "label": "గురుడు (బృహస్పతి)", "lines": ["దేవానాం చ ఋషీణాం చ గురుం కాంచనసన్నిభమ్ ।", "బుద్ధిమంతం త్రిలోకేశం తం నమామి బృహస్పతిమ్ ॥"] },
      { "label": "శుక్రుడు", "lines": ["హిమకుంద మృణాళాభం దైత్యానం పరమం గురుమ్ ।", "సర్వశాస్త్ర ప్రవక్తారం భార్గవం ప్రణమామ్యహమ్ ॥"] },
      { "label": "శని", "lines": ["నీలాంజన సమాభాసం రవిపుత్రం యమాగ్రజమ్ ।", "ఛాయా మార్తాండ సంభూతం తం నమామి శనైశ్చరమ్ ॥"] },
      { "label": "రాహువు", "lines": ["అర్ధకాయం మహావీరం చంద్రాదిత్య విమర్ధనమ్ ।", "సింహికా గర్భ సంభూతం తం రాహుం ప్రణమామ్యహమ్ ॥"] },
      { "label": "కేతువు", "lines": ["పలాశ పుష్ప సంకాశం తారకాగ్రహమస్తకమ్ ।", "రౌద్రం రౌద్రాత్మకం ఘోరం తం కేతుం ప్రణమామ్యహమ్ ॥"] },
      { "label": "ఫలశ్రుతి", "lines": ["ఇతి వ్యాస ముఖోద్గీతం యః పఠేత్సు సమాహితః ।", "దివా వా యది వా రాత్రౌ విఘ్నశాంతిర్భవిష్యతి ॥", "నరనారీనృపాణాం చ భవేద్దుఃస్వప్ననాశనమ్ ।", "ఐశ్వర్యమతులం తేషామారోగ్యం పుష్టి వర్ధనమ్ ॥", "గ్రహనక్షత్రజాః పీడాస్తస్కరాగ్ని సముద్భవాః ।", "తాస్సర్వాః ప్రశమం యాంతి వ్యాసో బ్రూతే న సంశయః ॥"] }
    ],
    "color": "#5B3A8E",
    "colorSoft": "#E6DFF0",
    "symbol": "navagraha",
  ...
  "adityahrudayam": {
    ...
    "type": "verses",
    "verses": [
      { "label": "ధ్యానం", "lines": ["నమస్సవిత్రే జగదేక చక్షుసే", "జగత్ప్రసూతి స్థితి నాశహేతవే", "త్రయీమయాయ త్రిగుణాత్మ ధారిణే", "విరించి నారాయణ శంకరాత్మనే"] },
      { "label": "1", "lines": ["తతో యుద్ధ పరిశ్రాంతం సమరే చింతయాస్థితమ్ ।", "రావణం చాగ్రతో దృష్ట్వా యుద్ధాయ సముపస్థితమ్ ॥"] },
      { "label": "2", "lines": ["దైవతైశ్చ సమాగమ్య ద్రష్టుమభ్యాగతో రణమ్ ।", "ఉపాగమ్యాబ్రవీద్రామం అగస్త్యో భగవాన్ ఋషిః ॥"] },
      { "label": "3", "lines": ["రామ రామ మహాబాహో శృణు గుహ్యం సనాతనమ్ ।", "యేన సర్వానరీన్ వత్స సమరే విజయిష్యసి ॥"] },
      { "label": "4", "lines": ["ఆదిత్యహృదయం పుణ్యం సర్వశత్రు-వినాశనమ్ ।", "జయావహం జపేన్నిత్యం అక్షయ్యం పరమం శివమ్ ॥"] },
      { "label": "5", "lines": ["సర్వమంగళ-మాంగళ్యం సర్వపాప-ప్రణాశనమ్ ।", "చింతాశోక-ప్రశమనం ఆయుర్వర్ధనముత్తమమ్ ॥"] },
      { "label": "6", "lines": ["రశ్మిమంతం సముద్యంతం దేవాసుర నమస్కృతమ్ ।", "పూజయస్వ వివస్వంతం భాస్కరం భువనేశ్వరమ్ ॥"] },
      { "label": "7", "lines": ["సర్వదేవాత్మకో హ్యేష తేజస్వీ రశ్మిభావనః ।", "ఏష దేవాసుర-గణాన్ లోకాన్ పాతి గభస్తిభిః ॥"] },
      { "label": "8", "lines": ["ఏష బ్రహ్మా చ విష్ణుశ్చ శివః స్కందః ప్రజాపతిః ।", "మహేంద్రో ధనదః కాలో యమః సోమో హ్యపాం పతిః ॥"] },
      { "label": "9", "lines": ["పితరో వసవః సాధ్యా హ్యశ్వినౌ మరుతో మనుః ।", "వాయుర్వహ్నిః ప్రజాప్రాణః ఋతుకర్తా ప్రభాకరః ॥"] },
      { "label": "10", "lines": ["ఆదిత్యః సవితా సూర్యః ఖగః పూషా గభస్తిమాన్ ।", "సువర్ణసదృశో భానుః హిరణ్యరేతా దివాకరః ॥"] },
      { "label": "11", "lines": ["హరిదశ్వః సహస్రార్చిః సప్తసప్తిర్మరీచిమాన్ ।", "తిమిరోన్మథనః శంభుః త్వష్టా మార్తాండకోంఽశుమాన్ ॥"] },
      { "label": "12", "lines": ["హిరణ్యగర్భః శిశిరః తపనో భాస్కరో రవిః ।", "అగ్నిగర్భోఽదితేః పుత్రః శంఖః శిశిరనాశనః ॥"] },
      { "label": "13", "lines": ["వ్యోమనాథస్తమోభేదీ ఋగ్యజుఃసామ-పారగః ।", "ఘనావృష్టిరపాం మిత్రః వింధ్యవీథీ ప్లవంగమః ॥"] },
      { "label": "14", "lines": ["ఆతపీ మండలీ మృత్యుః పింగళః సర్వతాపనః ।", "కవిర్విశ్వో మహాతేజా రక్తః సర్వభవోద్భవః ॥"] },
      { "label": "15", "lines": ["నక్షత్ర గ్రహ తారాణాం అధిపో విశ్వభావనః ।", "తేజసామపి తేజస్వీ ద్వాదశాత్మన్నమోఽస్తు తే ॥"] },
      { "label": "16", "lines": ["నమః పూర్వాయ గిరయే పశ్చిమాయాద్రయే నమః ।", "జ్యోతిర్గణానాం పతయే దినాధిపతయే నమః ॥"] },
      { "label": "17", "lines": ["జయాయ జయభద్రాయ హర్యశ్వాయ నమో నమః ।", "నమో నమః సహస్రాంశో ఆదిత్యాయ నమో నమః ॥"] },
      { "label": "18", "lines": ["నమ ఉగ్రాయ వీరాయ సారంగాయ నమో నమః ।", "నమః పద్మప్రబోధాయ మార్తాండాయ నమో నమః ॥"] },
      { "label": "19", "lines": ["బ్రహ్మేశానాచ్యుతేశాయ సూర్యాయాదిత్య-వర్చసే ।", "భాస్వతే సర్వభక్షాయ రౌద్రాయ వపుషే నమః ॥"] },
      { "label": "20", "lines": ["తమోఘ్నాయ హిమఘ్నాయ శత్రుఘ్నాయామితాత్మనే ।", "కృతఘ్నఘ్నాయ దేవాయ జ్యోతిషాం పతయే నమః ॥"] },
      { "label": "21", "lines": ["తప్త చామీకరాభాయ వహ్నయే విశ్వకర్మణే ।", "నమస్తమోఽభినిఘ్నాయ రవయే లోకసాక్షిణే ॥"] },
      { "label": "22", "lines": ["నాశయత్యేష వై భూతం తదేవ సృజతి ప్రభుః ।", "పాయత్యేష తపత్యేష వర్షత్యేష గభస్తిభిః ॥"] },
      { "label": "23", "lines": ["ఏష సుప్తేషు జాగర్తి భూతేషు పరినిష్ఠితః ।", "ఏష ఏవాగ్నిహోత్రం చ ఫలం చైవాగ్నిహోత్రిణామ్ ॥"] },
      { "label": "24", "lines": ["వేదాశ్చ క్రతవశ్చైవ క్రతూనాం ఫలమేవ చ ।", "యాని కృత్యాని లోకేషు సర్వ ఏష రవిః ప్రభుః ॥"] },
      { "label": "25", "lines": ["ఏనమాపత్సు కృచ్ఛ్రేషు కాంతారేషు భయేషు చ ।", "కీర్తయన్ పురుషః కశ్చిన్నావశీదతి రాఘవ ॥"] },
      { "label": "26", "lines": ["పూజయస్వైనమేకాగ్రః దేవదేవం జగత్పతిమ్ ।", "ఏతత్ త్రిగుణితం జప్త్వా యుద్ధేషు విజయిష్యసి ॥"] },
      { "label": "27", "lines": ["అస్మిన్ క్షణే మహాబాహో రావణం త్వం వధిష్యసి ।", "ఏవముక్త్వా తదాగస్త్యో జగామ చ యథాగతమ్ ॥"] },
      { "label": "28", "lines": ["ఏతచ్ఛ్రుత్వా మహాతేజాః నష్టశోకోఽభవత్తదా ।", "ధారయామాస సుప్రీతః రాఘవః ప్రయతాత్మవాన్ ॥"] },
      { "label": "29", "lines": ["ఆదిత్యం ప్రేక్ష్య జప్త్వా తు పరం హర్షమవాప్తవాన్ ।", "త్రిరాచమ్య శుచిర్భూత్వా ధనురాదాయ వీర్యవాన్ ॥"] },
      { "label": "30", "lines": ["రావణం ప్రేక్ష్య హృష్టాత్మా యుద్ధాయ సముపాగమత్ ।", "సర్వయత్నేన మహతా వధే తస్య ధృతోఽభవత్ ॥"] },
      { "label": "31", "lines": ["అథ రవిరవదన్నిరీక్ష్య రామం ముదితమనాః పరమం ప్రహృష్యమాణః ।", "నిశిచరపతి సంక్షయం విదిత్వా సురగణ మధ్యగతో వచస్త్వరేతి ॥"] }
    ],
